...
leaf.setup({
  ...
  overrides = {
    ...
    ["@constructor.tsx"]    = { fg = colors.dark },
    ["@property.tsx"]       = { fg = colors.red_hard },
    ["@tag.attribute.tsx"]  = { fg = colors.dark_dimmer },
    ["@tag.tsx"]            = { fg = colors.purple_dark },
    ...
    Cursor                  = { bg = "#DC7786" },
    -- CursorLineNr            = { bg = colors.light },
    CursorLine              = { bg = colors.light },
    ...
    Identifier              = { fg = colors.dark_dim },
    TSIdentifier            = { fg = colors.dark_dim },
